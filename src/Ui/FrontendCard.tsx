...
const FrontendCard: React.FC<FrontendCardProps> = ({ title, techUsed, imageUrl, progress }) => {
    ...
    return (
        <motion.div
            ...
            className="w-1/2 sm:w-1/2 md:w-1/4 lg:w-1/4 xl:w-1/4 px-3 mb-5"
        >
            <div className="bg-gray-100 rounded-lg overflow-hidden">
                ...
                <div className='overflow-hidden '>
                    ...
                    <h2 className="text-lg text-white font-medium title-font mb-4 frontendtitle">{title}</h2>
