...
const BackendCard: React.FC<BackendCardProps> = ({ title, techUsed, imageUrl, progress }) => {
        ...
        >
            <div className="bg-gray-100 rounded-lg overflow-hidden">
                ...
                <div className='overflow-hidden '>
                    ...
                    <h2 className="text-lg text-white font-medium title-font mb-4 backendtitle">{title}</h2>
